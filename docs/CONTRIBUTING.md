# PySATL TSP project contributing guide
...
1. Install `git` and clone your forked copy of the `repo`.
1. Build project following build instructions in [README.md](index.md) file, make sure everything is ok.
1. Run tests following instructions in [README.md](index.md) file, make sure all tests passing.
1. Implement new feature or fix existing one in the source code.
1. Make docstrings and update documentation using `poetry run mkdocs serve`
1. Commit your changes.
1. Open a pull-request.
1. Wait for review from developers of the project.
1. Fix major and minor issues if presented.
1. Get your work merged into `main`!
